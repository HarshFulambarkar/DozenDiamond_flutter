...
class _PinPaint extends CustomPainter {
  ...
  _PinPaint({
    ...
    textStyle: decoration.textStyle ?? themeData!.textTheme.displayLarge!,
    ...
    hintTextStyle: decoration.hintTextStyle ??
        ...
        themeData!.textTheme.displayLarge!.copyWith(color: themeData.hintColor),
  );
...
//             final FormFieldState<String> state = field;
