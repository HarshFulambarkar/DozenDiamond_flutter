...
class AdjustStepSizeScreenNew extends StatelessWidget {
  AdjustStepSizeScreenNew({super.key});
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          buildStepSizeField(context, screenWidth),
  ...
  Widget buildStepSizeField(BuildContext context, double screenWidth) {
    return Padding(
      padding: const EdgeInsets.only(left: 8, right: 8.0),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          ...
          SizedBox(
            ...
            child: MyTextField(
              prefixText: "",
              controller:
              modifyLadderTargetPriceProvider.modifiedStepSizeController,
              isFilled: true,
              ...
              labelText: '',
              onChanged: (value) {
                modifyLadderTargetPriceProvider.stepSizeCheckBox = false;
                if (modifyLadderTargetPriceProvider.modifiedStepSizeController.text != "") {

                  modifyLadderTargetPriceProvider.modifiedStepSize =
                      double.tryParse(modifyLadderTargetPriceProvider
                          .modifiedStepSizeController.text) ??
                          0.0;

                  if(modifyLadderTargetPriceProvider.modifiedStepSize < modifyLadderTargetPriceProvider.minStepSize || modifyLadderTargetPriceProvider.modifiedStepSize > modifyLadderTargetPriceProvider.maxStepSize) {

                    modifyLadderTargetPriceProvider.stepSizeError = "Step Size should be in  range ${modifyLadderTargetPriceProvider.minStepSize.roundTo2()} to ${modifyLadderTargetPriceProvider.maxStepSize.roundTo2()}";

                  } else {
                    modifyLadderTargetPriceProvider.stepSizeError = "";
                  }
                }
              },
              validator: (value) {
  ...
  Widget buildCheckBoxAndSaveLadderButton(BuildContext context) {
    return Column(
      ...
      children: [
            ...
            SizedBox(
              ...
              child: Checkbox(
                ...
                value: modifyLadderTargetPriceProvider
                    .stepSizeCheckBox, //ladderAddOrWithdrawCashProvider.updateCheckbox,
                ...
                onChanged: (bool? newValue) {
                  if(modifyLadderTargetPriceProvider.modifiedStepSize < modifyLadderTargetPriceProvider.minStepSize || modifyLadderTargetPriceProvider.modifiedStepSize > modifyLadderTargetPriceProvider.maxStepSize) {
                    ...
                    modifyLadderTargetPriceProvider.stepSizeError = "";
                    modifyLadderTargetPriceProvider.modifyStepSize();
                  }
        ...
        //             "")
        (modifyLadderTargetPriceProvider.isModifyingStepSize)
        ...
        ElevatedButton(
          ...
          onPressed: () async {
            if (false) {
              ...
              modifyLadderTargetPriceProvider
                  .modifyStepSizeBusinessLogic(context);
            }
          },
          ...
          children: [
            ...
            Expanded(
              ...
              child: Align(
                alignment: Alignment.centerRight,
                child: Text(
                    modifyLadderTargetPriceProvider.calculatedStepSize
                        .toStringAsFixed(2),
                    style: GoogleFonts.poppins(
                      fontWeight: FontWeight.w500,
                      fontSize: 16,
