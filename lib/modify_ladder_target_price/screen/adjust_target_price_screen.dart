...
class ModifyLadderTargetPriceScreen extends StatelessWidget {
  ModifyLadderTargetPriceScreen({super.key});
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          buildLadderTargetPriceField(context),
  ...
  buildLadderTargetPriceField(BuildContext context) {
    return Row(
      children: [
        Expanded(
          flex: 1,
      ...
      children: [
        ...
        Row(
          children: [
            Expanded(
              flex: 1,
              child: modifyLadderTargetPriceProvider.initialBuyExecuted == 1
                  ? modifyLadderTargetPriceProvider.modifiedTargetPrice >
                          modifyLadderTargetPriceProvider.targetPrice
                      ? Text("Stocks to buy")
                      : Text("Stocks to sell")
                  : Text("New Initial Buy Quantity"),
            ),
            Expanded(
              flex: 1,
              child: Align(
