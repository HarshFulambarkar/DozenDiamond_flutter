...
class AdjustStepSizeScreen extends StatelessWidget {
  AdjustStepSizeScreen({super.key});
  ...
  buildStepSizeField(BuildContext context) {
    return Row(
      children: [
        Expanded(
          flex: 1,
          ...
          child: Column(
            ...
            children: [
              MyTextField(
                ...
                isFilled: true,
                leading: Text(
                    "${currencyConstantsProvider.currency}",
                    style: TextStyle(
                        fontSize: 16,
                        color: (themeProvider.defaultTheme)
                            ? Colors.black
                ...
                fillColor: (themeProvider.defaultTheme)
                    ? Color(0xffCACAD3)
                    : Color(0xff2c2c31), // Colors.transparent,
