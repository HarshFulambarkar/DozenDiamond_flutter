...
class AnalysisValueVsNumberOfStocksScreen extends StatefulWidget {
  final AnalysisType userSelectedAnalysis;
  final String userSelectedStock;
  const AnalysisValueVsNumberOfStocksScreen(
      {super.key,
        required this.userSelectedAnalysis,
        required this.userSelectedStock});

  @override
  State<AnalysisValueVsNumberOfStocksScreen> createState() => _AnalysisValueVsNumberOfStocksScreenState();
}

class _AnalysisValueVsNumberOfStocksScreenState extends State<AnalysisValueVsNumberOfStocksScreen> {
  ...
  void initState() {
    ...
    getValueVsNumberOfStocksGraphData();
  ...
  Widget stockValueVsNumberOfStocksCsvDialog() {
    return Container(
      child: TextButton(
        onPressed: () {
          showDialog(
  ...
  Future<void> getValueVsNumberOfStocksGraphData() async {
    print("inside getValueVsNumberOfStocksGraphData");
    ...
    try {
      ...
      if (graphData!.status!) {
        ...
        for (var entry in graphData!.data!) {
          if (!(entry.type == "Cumulative")) {
            ...
            double value = entry.units!.toDouble() * entry.price!.toDouble();
            double numberOfStocks = entry.units!.toDouble();
            print("------------------------");
            ...
            hiddenGraphData.add(FlSpot(numberOfStocks, value));
      ...
      print("getValueVsNumberOfStockGraphData function $err");
                ...
                for (int i = 0; i < value.length; i++) {
                  if (i == value.length - 1) {
                    ...
                    tooltipData.add(LineTooltipItem(
                        "${i == 0 ? 'Stock Value: ${value[i].x}\n' : ''}No. of Stocks: ${value[i].y.toStringAsFixed(2)}",
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        _selectedAnalysisType!.itemId == 4 || //1 ||
                          ...
                          children: [
                            stockValueVsNumberOfStocksCsvDialog(),
                            Container(
                                height:
              ...
              child: ElevatedButton(
                onPressed: () async {
                  ...
                  AnalysisProfitVsPriceRestApiService()
                      .stockValueVsNumberOfStockAnalyticsCsv(
                      data
