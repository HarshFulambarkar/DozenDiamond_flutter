...
class AnalysisPriceVsNumberOfStocksScreen extends StatefulWidget {
  final AnalysisType userSelectedAnalysis;
  final String userSelectedStock;
  const AnalysisPriceVsNumberOfStocksScreen(
      {super.key,
        required this.userSelectedAnalysis,
        required this.userSelectedStock});

  @override
  State<AnalysisPriceVsNumberOfStocksScreen> createState() => _AnalysisPriceVsNumberOfStocksScreenState();
}

class _AnalysisPriceVsNumberOfStocksScreenState extends State<AnalysisPriceVsNumberOfStocksScreen> {
  ...
  void initState() {
    ...
    getProfitVsNumberOfStocksGraphData();
  ...
  Widget priceVsNumberOfStocksCsvDialog() {
    return Container(
      child: TextButton(
        onPressed: () {
          showDialog(
  ...
  Future<void> getProfitVsNumberOfStocksGraphData() async {
    print("inside getProfitVsNumberOfStocksGraphData");
    ...
    try {
      ...
      if (graphData!.status!) {
        ...
        for (var entry in graphData!.data!) {
          if (!(entry.type == "Cumulative")) {
            ...
            hiddenGraphData.add(FlSpot(entry.price ?? 0.0, numberOfStocks));
      ...
      print("getPriceVsNumberOfStockGraphData function $err");
  ...
  Widget priceVsNumberOfStocksLineChart() {
    return LineChart(
      LineChartData(
                  ...
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        //   ),
                        // ),
                        _selectedAnalysisType!.itemId == 2 || //1 ||
                          ...
                          children: [
                            priceVsNumberOfStocksCsvDialog(),
                            Container(
                                height:
                                ...
                                child: priceVsNumberOfStocksLineChart()),
                            Container(
