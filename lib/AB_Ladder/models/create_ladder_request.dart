...
class CreateLadderRequest extends ApiRequestResponse {
  ...
  bool? continueTradingAfterHittingTargetPrice = false;
  double? ladCashAssigned = 0;
  double? estimatedExtraCashPerMonth = 0;
  ...
  CreateLadderRequest({
    ...
    this.estimatedExtraCashPerMonth,
  });
  ...
  CreateLadderRequest fromJson(Map<String, dynamic> json) {
    ...
    ladTargetPrice = json['lad_target_price_multiplier'];
    continueTradingAfterHittingTargetPrice =
        json['continue_trading_after_hitting_target_price'];
    ladCashAssigned = json['lad_cash_assigned'];
    estimatedExtraCashPerMonth = json['estimated_extra_cash_per_month'];
    return this;
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    data['continue_trading_after_hitting_target_price'] =
        this.continueTradingAfterHittingTargetPrice;
    data['lad_cash_assigned'] = this.ladCashAssigned;
    data['estimated_extra_cash_per_month'] = this.estimatedExtraCashPerMonth;
    return data;
  }
}
