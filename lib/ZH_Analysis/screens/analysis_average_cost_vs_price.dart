...
class AnalysisAverageCostVsPriceScreen extends StatefulWidget {
  final AnalysisType userSelectedAnalysis;
  final String userSelectedStock;
  const AnalysisAverageCostVsPriceScreen(
      {super.key,
        required this.userSelectedAnalysis,
        required this.userSelectedStock});

  @override
  State<AnalysisAverageCostVsPriceScreen> createState() => _AnalysisAverageCostVsPriceScreenState();
}

class _AnalysisAverageCostVsPriceScreenState extends State<AnalysisAverageCostVsPriceScreen> {
  ...
  Widget averageCostVsPriceCsvDialog() {
    return Container(
      child: TextButton(
        onPressed: () {
          // showDialog(
    ...
    try {
      ...
      if (graphData!.status!) {
        ...
        for (var entry in graphData!.data!) {
          ...
          hiddenGraphData.add(FlSpot(price, averageCost, ));
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        _selectedAnalysisType!.itemId == 4 || //1 ||
                            _selectedAnalysisType!.itemId == 6
                            ? !_graphDataAvailable
                            ? (loadingGraphData)
                            ?Container(
              ...
              child: ElevatedButton(
                onPressed: () async {
                  ...
                  AnalyticsRestApiService()
                      .stockAverageCostVsPriceAnalyticsCsv(
                      data
