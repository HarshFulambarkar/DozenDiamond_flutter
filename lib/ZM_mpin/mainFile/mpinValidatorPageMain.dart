...
import '../screens/mpin_validator_page.dart';
import '../screens/mpin_validator_page_new.dart';
  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      ...
      child: MaterialApp(
        ...
        routes: {
          // "/": (context) => MpinValidatorPage(fetchUserData: true),
          "/": (context) => MpinValidatorPageNew(fetchUserData: true),
        },
      ),
