...
class TradeTableCsvDialog extends StatefulWidget {
  final String? stockName;
  TradeTableCsvDialog({super.key, required this.stockName});

  @override
  State<TradeTableCsvDialog> createState() =>
      _TradeTableCsvDialogState();
}

class _TradeTableCsvDialogState
    extends State<TradeTableCsvDialog> {
