class SettledClosestTradeResponse {
  bool? status;
  String? message;
  Success? success;
  List<SettledClosestTradeData>? data;
  Total? total;

  SettledClosestTradeResponse(
      {this.status, this.message, this.success, this.data, this.total});

  SettledClosestTradeResponse.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    message = json['message'];
    success =
    json['success'] != null ? new Success.fromJson(json['success']) : null;
    if (json['data'] != null) {
      data = <SettledClosestTradeData>[];
      json['data'].forEach((v) {
        data!.add(new SettledClosestTradeData.fromJson(v));
      });
    }
...
class SettledClosestTradeData {
  ...
  SettledClosestTradeData.fromJson(Map<String, dynamic> json) {
