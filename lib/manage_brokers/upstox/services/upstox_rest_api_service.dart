...
class UpstoxRestApiService {
  ...
  Future<UpstoxLoginResponse> doUpstoxLogin(
      Map<String, dynamic>? requestBody) async {
    try {
      var accessToken = await _generateToken;

      final userId = await getUserID();
      var url = Uri.parse("$baseUrl_v2$userId/upstox/login");
      ...
      print("below is upstox login response");
      print(url);
      print(payload);
      print(response.body);
