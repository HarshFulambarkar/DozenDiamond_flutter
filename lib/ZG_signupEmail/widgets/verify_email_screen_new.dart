...
class VerifyEmailScreenNew extends StatefulWidget {
  const VerifyEmailScreenNew({super.key});

  @override
  State<VerifyEmailScreenNew> createState() => _VerifyEmailScreenNewState();
}

class _VerifyEmailScreenNewState extends State<VerifyEmailScreenNew> with CodeAutoFill {
