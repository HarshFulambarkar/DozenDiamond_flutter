...
class SettledRecentTradeTableResponse implements ApiRequestResponse {
  List<Data>? data;
  String? totalProfit;
  String? msg;
  bool? status;

  SettledRecentTradeTableResponse(
      {this.data, this.totalProfit, this.msg, this.status});

  @override
  SettledRecentTradeTableResponse fromJson(Map<String, dynamic> json) {
    if (json['data'] != null) {
      data = <Data>[];
      json['data'].forEach((v) {
