class SettledRecentTradeResponse {
  bool? status;
  String? message;
  Success? success;
  List<SettledRecentTradeData>? data;
  Total? total;

  SettledRecentTradeResponse(
      {this.status, this.message, this.success, this.data, this.total});

  SettledRecentTradeResponse.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    message = json['message'];
    success =
    json['success'] != null ? new Success.fromJson(json['success']) : null;
    if (json['data'] != null) {
      data = <SettledRecentTradeData>[];
      json['data'].forEach((v) {
        data!.add(new SettledRecentTradeData.fromJson(v));
      });
    }
...
class SettledRecentTradeData {
  ...
  SettledRecentTradeData.fromJson(Map<String, dynamic> json) {
