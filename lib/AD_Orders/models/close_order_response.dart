...
class CloseOrderResponse implements ApiRequestResponse {
  bool? status;
  String? message;
  Success? success;

  CloseOrderResponse({this.status, this.message, this.success});
  @override
  CloseOrderResponse fromJson(Map<String, dynamic> json) {
    status = json['status'];
