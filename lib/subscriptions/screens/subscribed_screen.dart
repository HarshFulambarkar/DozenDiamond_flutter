                  ...
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        //     ?subscribedCard(subscriptionProvider.subscriptionList[0], context):Container(),
                      ],
                    ),
                  ),
                ),
                    ...
                    children: [
                      Text.rich(TextSpan(text: '', children: <InlineSpan>[
                        TextSpan(
                          ...
                          (subscriptionProvider.subscribedData.amount == null)
                              ?"-"
                        ...
                        TextSpan(
                          text: "/${subscriptionProvider.subscribedData.duration ?? ""}",
                          style: TextStyle(
                              fontSize: 16,
                              color: (themeProvider.defaultTheme)?Color(0xff141414):Color(0xfff0f0f0),
                              fontWeight: FontWeight.w700
