...
class AnalyticsUnsettledRecentBuyTableResponse implements ApiRequestResponse {
  List<Data>? data;
  ...
  AnalyticsUnsettledRecentBuyTableResponse(
      {this.data,
  ...
  @override
  AnalyticsUnsettledRecentBuyTableResponse fromJson(Map<String, dynamic> json) {
    if (json['data'] != null) {
      data = <Data>[];
      json['data'].forEach((v) {
