class AnalyticsUnsettledRecentBuyResponse {
  bool? status;
  String? message;
  Success? success;
  List<AnalyticsUnsettledRecentBuyData>? data;
  Total? total;

  AnalyticsUnsettledRecentBuyResponse(
      {this.status, this.message, this.success, this.data, this.total});

  AnalyticsUnsettledRecentBuyResponse.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    message = json['message'];
    success =
    json['success'] != null ? new Success.fromJson(json['success']) : null;
    if (json['data'] != null) {
      data = <AnalyticsUnsettledRecentBuyData>[];
      json['data'].forEach((v) {
        data!.add(new AnalyticsUnsettledRecentBuyData.fromJson(v));
      });
    }
...
class AnalyticsUnsettledRecentBuyData {
  int? tradeNumber;
  String? stockName;
  double? price;
  int? units;
  ...
  AnalyticsUnsettledRecentBuyData(
      {this.tradeNumber,
        this.stockName,
        this.price,
        this.units,
  ...
  AnalyticsUnsettledRecentBuyData.fromJson(Map<String, dynamic> json) {
