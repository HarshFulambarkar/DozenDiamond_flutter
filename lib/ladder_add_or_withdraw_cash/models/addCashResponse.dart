...
class AddCashResponse implements ApiRequestResponse {
  String? message;
  bool? status;
  Success? success;

  AddCashResponse({this.message, this.status, this.success});
  @override
  AddCashResponse fromJson(Map<String, dynamic> json) {
