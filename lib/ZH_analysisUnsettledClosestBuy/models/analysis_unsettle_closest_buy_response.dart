class AnalysisUnsettleClosestBuyResponse {
  bool? status;
  String? message;
  Success? success;
  List<AnalysisUnsettleClosestBuyData>? data;
  Total? total;

  AnalysisUnsettleClosestBuyResponse(
      {this.status, this.message, this.success, this.data, this.total});

  AnalysisUnsettleClosestBuyResponse.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    message = json['message'];
    success =
    json['success'] != null ? new Success.fromJson(json['success']) : null;
    if (json['data'] != null) {
      data = <AnalysisUnsettleClosestBuyData>[];
      json['data'].forEach((v) {
        data!.add(new AnalysisUnsettleClosestBuyData.fromJson(v));
      });
    }
...
class AnalysisUnsettleClosestBuyData {
  int? tradeNumber;
  String? stockName;
  double? price;
  int? units;
  ...
  AnalysisUnsettleClosestBuyData(
      {this.tradeNumber,
        this.stockName,
        this.price,
        this.units,
  ...
  AnalysisUnsettleClosestBuyData.fromJson(Map<String, dynamic> json) {
...
class Total {
  ...
  Total.fromJson(Map<String, dynamic> json) {
    netCashGain = json['net_cash_gain'];
