...
import 'manage_brokers/shoonya/stateManagement/shoonya_broker_provider.dart';
      ...
      try {
        await Firebase.initializeApp(
          options: FirebaseOptions(
            apiKey: "AIzaSyCuo8rYvv5d-uiJeqeWlhK_6EGivP-bGiU",
            appId: "1:486769585980:ios:4a70450dc5ab6a41ed3839",
            messagingSenderId: "486769585980",
            projectId: "dozen-diamonds-5b32d",
          ),
        );
  ...
  Widget build(BuildContext context) {
    ...
    return MultiProvider(
      providers: [
        ...
        ChangeNotifierProvider(
            create: (_) =>
                QuestionnaireProvider(navigatorKey)..loadQuestions()),
        ...
        ChangeNotifierProvider(create: (_) => ShoonyaBrokersProvider(navigatorKey)),
